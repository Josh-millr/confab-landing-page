...
export const Hero = () => {
  return (
    <div role="banner" className="grid gap-y-[35px]">
      ...
      <div className="rounded-[24px] bg-[url('/images/illustration.png')] bg-cover bg-center">
        <div className="rounded-[24px] bg-[#5CD0C545]">
          <div className="mx-pageMargin-sm grid grid-cols-1 grid-rows-1 md:mx-pageMargin-md md:grid-cols-2 md:grid-rows-2 md:py-[20px] lg:mx-pageMargin-lg">
            {/* column 1 */}
            <div className="flex items-center justify-end md:items-start md:justify-start md:px-[16px]">
            ...
            {/* column 2 */}
            <div className="flex items-center justify-center md:col-start-1 md:col-end-2 md:row-start-1 md:row-end-3 lg:justify-start">
              <div className="grid grid-rows-1 gap-y-[64px] rounded-[30px] bg-white py-[42px] px-[30px] md:max-w-[344px] md:gap-y-[140px] lg:max-w-[360px] lg:p-[32px]">
            ...
            {/* column 3 */}
            <div className="flex items-center justify-center gap-x-[8px] py-[24px] md:items-end md:pb-[8px] md:pt-[0px] lg:justify-end">
              <Button
                label="Remind me"
